    ...
    <ul className="space-y-1">
      {items.map((a, i) => (
        <motion.li
          ...
          className="flex items-center gap-3 rounded-lg px-2 py-2 transition-colors duration-300 hover:bg-surface"
        >
          <span className="grid h-9 w-9 shrink-0 place-items-center rounded-full border border-line bg-surface text-accent-soft">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-[11px] text-ink-subtle">{a.raffleTitle}</p>
          </div>

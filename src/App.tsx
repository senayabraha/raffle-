...
const AdminFeeSettings = lazy(() => import("@/pages/admin/FeeSettingsAdmin"));
const AdminWithheldTaxes = lazy(() => import("@/pages/admin/WithheldTaxes"));
        ...
        <Suspense fallback={<FullPageSpinner />}>
          <Routes>
            ...
            >
              ...
              <Route path="fees" element={<AdminFeeSettings />} />
              <Route path="withheld-taxes" element={<AdminWithheldTaxes />} />
            </Route>

...
/* ---------- Input ---------- */
const baseInput =
  "focus-ring h-11 w-full rounded-xl border border-line bg-surface px-3.5 text-sm text-ink placeholder:text-ink-subtle transition-colors duration-300 hover:border-line focus:border-accent/50";
...
>(({ className, ...props }, ref) => (
  <textarea
    ref={ref}
    className={cn(
      "focus-ring min-h-[110px] w-full resize-y rounded-xl border border-line bg-surface p-3.5 text-sm text-ink placeholder:text-ink-subtle transition-colors duration-300 hover:border-line focus:border-accent/50",
      className,
    )}
    {...props}
  />
  ...
  return (
    <button
      ...
      className={cn(
        ...
        checked ? "bg-accent shadow-accent-glow" : "bg-surface-2",
      )}
    >
      <span
        className={cn(
          ...
          <button
            ...
            className={cn(
              ...
              active
                ...
                : "border-line bg-surface hover:border-line hover:bg-surface",
            )}
          >
            {o.icon && (
              <span
